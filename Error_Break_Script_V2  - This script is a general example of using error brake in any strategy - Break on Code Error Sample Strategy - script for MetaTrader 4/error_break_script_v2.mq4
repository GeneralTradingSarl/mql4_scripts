...
#property link          "persinaru@gmail.com"
#property link          "Iulian Persinaru - 2024 - free open source"
#property description   "This script is a general example of using error brake in any strategy."
...
void OnStart()
  {
   int symbol = OrderSend(Symbol(),OP_BUY,0.1,0.00,10,0,0,"",0,0,0);
   PlaySound("alert.wav");
   Break_On_Error();
